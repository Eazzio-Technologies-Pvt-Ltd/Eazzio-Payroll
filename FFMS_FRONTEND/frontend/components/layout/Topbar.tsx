...
const pageTitles: Record<string, { title: string; subtitle: string }> = {
  ...
  "/reports/travel-logs": { title: "Travel Odometer Logs", subtitle: "Track meter logs, verified distance travels, and monthly conveyance allowance" },
...
const searchablePages = [
  ...
  { label: "Travel Odometer Logs", path: "/reports/travel-logs", keywords: ["travel logs", "odometer", "distance", "conveyance"] },
