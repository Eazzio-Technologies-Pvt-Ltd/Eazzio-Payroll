...
const Card = ({
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-white p-2 rounded-[25px] shadow-[0px_10px_20px_0px_#D3D3D3] border border-neutral-100 dark:border-neutral-200">
        ...
        >
          ...
          <h3 className="text-2xl font-semibold text-neutral-800 dark:text-neutral-800 leading-none mb-[10px]">
            {title}
          </h3>
          <p className="text-neutral-500 dark:text-neutral-500 text-sm/5 tracking-tight">
            {description}
          </p>
        </div>
      </div>
...
export default function HowItWorks({
  ...
  return (
    <LazyMotion features={domAnimation}>
      <div
        className={twMerge(
          "bg-white dark:bg-black max-md:pt-10 max-md:pb-25 md:py-20 px-8 relative",
          className
        )}
      >
        <div
